...
public class ResponseTypesController extends BaseController {    
    ...
    public void getStringEnumArrayAsync(
        ...
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5152005236126354315L;
            {
                    put( "array", "true" );
                    put( "type", "string" );
            }});
        ...
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4893975767346091050L;
            {
    ...
    public void getBooleanArrayAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5519103243400105689L;
            {
                    put( "array", "true" );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5720483995575781326L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
    ...
    public void getHeadersAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4977212898313239799L;
            {
                    put( "user-agent", "Stamplay SDK" );
            }
        };
    ...
    public void getBooleanAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5683097227942016799L;
            {
                    put( "user-agent", "Stamplay SDK" );
            }
        };
    ...
    public void getDatetimeAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4718283722012626301L;
            {
                    put( "user-agent", "Stamplay SDK" );
            }
        };
    ...
    public void getDatetimeArrayAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4707005726837356128L;
            {
                    put( "array", "true" );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4768306095252912683L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
    ...
    public void getDynamicAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4913147721531809896L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
    ...
    public void getDynamicArrayAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5245396123382585947L;
            {
                    put( "array", "true" );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5027905906857015494L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
    ...
    public void getIntegerArrayAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5039425815099494453L;
            {
                    put( "array", "true" );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5566214023520911302L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
    ...
    public void getIntegerAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5650762115369223307L;
            {
                    put( "user-agent", "Stamplay SDK" );
            }
        };
    ...
    public void getBinaryAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5440663080337671809L;
            {
                    put( "user-agent", "Stamplay SDK" );
            }
        };
    ...
    public void getPrecisionAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4718857291406187331L;
            {
                    put( "user-agent", "Stamplay SDK" );
            }
        };
    ...
    public void getIntEnumArrayAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 4730361443227689605L;
            {
                    put( "array", "true" );
                    put( "type", "int" );
            }});
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4773460874418024509L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
    ...
    public void getIntEnumAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5475902855568030469L;
            {
                    put( "type", "int" );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4678030950582509568L;
            {
                    put( "user-agent", "Stamplay SDK" );
            }
        };
    ...
    public void getModelArrayAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5008197035557384041L;
            {
                    put( "array", "true" );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4885401811451577043L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
    ...
    public void getModelAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5738739206289387852L;
            {
                    put( "user-agent", "Stamplay SDK" );
                    put( "accept", "application/json" );
            }
    ...
    public void getLongAsync(
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 4852359265232013251L;
            {
                    put( "user-agent", "Stamplay SDK" );
            }
        };
    ...
    public void getStringEnumAsync(
        ...
        //process query parameters
        APIHelper.appendUrlWithQueryParameters(_queryBuilder, new HashMap<String, Object>() {
            private static final long serialVersionUID = 5027839333220543794L;
            {
                    put( "type", "string" );
            }});
        //validate and preprocess url
        ...
        //load all headers for the outgoing API request
        Map<String, String> _headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5276114230633178330L;
            {
                    put( "user-agent", "Stamplay SDK" );
            }
        };
